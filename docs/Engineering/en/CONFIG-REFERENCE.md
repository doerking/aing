...
|---|---|---|---|
| KQ | Quality | 0.15 | confidence, logical consistency |
| KG | Growth | 0.12 | week-over-week growth rate |
| KA | Assetization | 0.13 | transplant readiness |
| KM | Metabolism | 0.12 | expiry cleanup rate |
| KD | Density | 0.13 | link completeness |
| KC | Retrieval | 0.10 | hit rate |
| KR | Response | 0.15 | accuracy |
| KB | Block | 0.10 | security event count |
