# ADR-002: Single SQLite, Zero External Dependencies
...
Target hardware = **ordinary home / budget PC**: low RAM, single disk, no Docker.

Alternatives considered:
- PostgreSQL + pgvector (feature-rich but heavy)
- Neo4j (graph-strong but needs JVM)
