...
Body contains: Source reference, Content (first 500 chars), Relations (wikilinks), KESPI status (JSON block).

### wiki/links/*.md

Each link is a Markdown file with source, target, type, and created fields.
...
|---|---|---|---|---|---|
| KQ | Quality | 0.15 | < 0.70 | = 0.00 | verify_conflict |
| KG | Growth | 0.12 | < 0.05 | = 0.00 | pollinate_orphan |
| KA | Assetization | 0.13 | < 0.60 | = 0.00 | transplant_remind |
| KM | Metabolism | 0.12 | 0.60–0.74 | ≥ 0.75 | regenerate_expired |
| KD | Density | 0.13 | > 0.20 | = 0.00 | link_suggest |
| KC | Retrieval | 0.10 | < 0.70 | = 0.00 | optimize_index |
| KR | Response | 0.15 | < 0.85 | = 0.00 | fine_tune |
| KB | Block | 0.10 | = 0.00 | ≥ 1 | freeze_writes |
